...
function Cartui() {
  ...
  const { order, cartproduct, setCartproduct, fetchCartData } =useContext(Cartcontext);
  ...
  return (
    <div className="p-6 space-y-4 mt-20 bg-yellow-100">
      {cartproduct.map((item, index) => (
        <div
          key={index}
          className="flex flex-col md:flex-row items-center bg-slate-100 shadow-lg rounded-lg p-4 md:p-6 space-y-4 md:space-y-0 md:space-x-6"
        >
          ...
          <div className="flex flex-col md:flex-row items-center md:space-x-4 space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2">
              <button
                className="px-3 py-1 text-lg font-semibold bg-gray-500 hover:bg-gray-700 rounded"
                onClick={() =>
      ...
      <div className="flex justify-between items-center mt-8">
        ...
        <div className="space-x-4">
          <button
            className="m-2 bg-green-600 hover:bg-green-700 p-2 rounded"
            onClick={orderhandil}
          >
            <MdShoppingCartCheckout />
          </button>
          <button
            className="m-2 bg-red-600 hover:bg-red-700 p-2 rounded"
            onClick={clearCart}
          >
            <RiDeleteBin6Line />
          </button>

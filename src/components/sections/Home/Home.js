...
function Home() {
  ...
  <h5 className="text-2xl font-semibold text-gray-700">As Featured In:</h5>
  <div className="flex justify-center space-x-6 mt-6">
    {[...Array(5)].map((_, index) => (
      <div key={index} className="w-40">
        <img
          src={`https://websitedemos.net/recycled-shoe-store-04/wp-content/uploads/sites/983/2021/11/recycled-shoe-store-featured-in-logo-${index + 1}.svg`}
          alt={`Brand ${index + 1}`}
        ...
        <div className="flex flex-col md:flex-row justify-center items-center my-10 px-4">
          ...
          <div className="md:w-1/2 px-6 text-center md:text-left">
            ...
            <p className="mt-4 text-gray-600">
              Crafted from eco-friendly materials, designed for durability, and comfort
              for every step. Our shoes are perfect for all-day wear.
            </p>
          </div>
        </div>
